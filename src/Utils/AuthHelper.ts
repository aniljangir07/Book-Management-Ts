...
// <----------------------------------------------Password DeCoder---------------------------------------->
export const comparePassword = async (planPassword: string, hashedPassword: string): Promise<boolean> => {
  try {
...
export const authenticateToken = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (token == null) return res.status(statusCodes.UNAUTHORIZED).json({
    success: false,
